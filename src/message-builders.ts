 ...
 * mirrors the webapp client's own payment/audio message builders so bots
 * send the same well-typed shape the webapp client does, instead of
 * hand-rolling envelope JSON inline.
 */
