...
// ~1 XAH vs XRPL's ~10 XRP order of magnitude reversed — always ask the
...
// sit in submitAndWait for a full 20 ledgers — at Xahau's ~4s close time,
// up to ~80s — before it even fails once. A much shorter window here just
...
// confirmed by testing, where every attempt autofilled the same ~20 drops.
